...
# @Time    : 19-7-4 下午9:13
# @Author  : tangming
# @File    : tc_net_rnn_onernn_notime_pool3.py

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 19-7-4 下午6:06
# @Author  : tangming
# @File    : tc_net_rnn_onernn_notime_pool2.py
...
class LossHistory(keras.callbacks.Callback):
    ...
    def draw_p(self, lists, label, type):
        ...
        np.savetxt(label+'_'+type+'.txt', lists)
...
if __name__ == '__main__':
    ...
    history.end_draw()
    # <batch_size> dropout=0.3
    # batch_size = 128, epoch=100, best_val_acc=0.94200;
    # batch_size = 64, epoch=100, best_val_acc=0.94300;
    # batch_size = 32, epoch=100, best_val_acc=0.96950
    # batch_size = 16, epoch=100, best_val_acc=0.97950


    #best_val_acc:0.98700
    #卷积核增大:7,5,5,3,,best_val_acc:0.99100 (1)GRU改成LSTM后best_val_acc:0.99050 (2)GRU改成BiGRU后best_val_acc:0.98850 (3)GRU改成BiLSTM后best_val_acc:0.98800
    #                                        (4)双层GRU:best_val_acc:0.99200     (5)双层GRU+全连接层128后best_val_acc:0.98850 (6)双层GRU+全连接层128+dropout后best_val_acc:0.98800
    #                                        (7)双层GRU+全连接层256+dropout后best_val_acc:0.99100
    #                                         (10)双层GRU+全连接层512+dropout后best_val_acc:0.98950
    #卷积核增大:7,5,5,3,3,,best_val_acc:0.98950