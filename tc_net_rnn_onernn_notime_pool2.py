...
def create_model():
    ...
    # CONV-RELU-POOL 5
    conv5 = Conv2D(32, (3, 3), activation="relu", kernel_regularizer=regularizers.l2(0.01))(batch_normal4)
    pool5 = MaxPooling2D(pool_size=(3, 3), strides=(1, 2), padding='same')(conv5)
    batch_normal5 = BatchNormalization(axis=-1)(pool5)
    ...
    gru_input = Reshape((84, 160))(batch_normal5)
...
if __name__ == '__main__':
    ...
    #卷积核增大:7,5,3,3,3,,best_val_acc:0.98750