...
def create_model():
    ...
    dropout1 = Dropout(0.2)(batch_normal_5)
    # output-layer
...
if __name__ == '__main__':
    ...
    hist = model.fit(wavs, labels, batch_size=128, epochs=100, validation_data=(val_wavs, val_labels),
    ...
    # <batch_size> dropout=0.2
    # batch_size = 128, epoch=100, best_val_acc=0.94100;
    # batch_size = 64, epoch=100, best_val_acc=0.96450;
    # batch_size = 32, epoch=100, best_val_acc=0.96400
    # batch_size = 16, epoch=100, best_val_acc=0.97150
