...
def create_model():
    ...
    dropout1 = Dropout(0.3)(batch_normal_5)
    # output-layer
    ...
    model.compile(loss=categorical_crossentropy, optimizer=keras.optimizers.SGD(lr=2e-3, momentum=0.75), metrics=['accuracy'])
    #model.summary()
    return model
...
if __name__ == '__main__':
    ...
    history.end_draw()
    # <batch_size> dropout=0.3, SGD<lr=2e-3, 2e-2, momentum=0.8, 0.6, 0.4, 0.2, 0>
    # baseline:  batch_size=16, dropout=0.3 , optimizer= SGD(2e-3, mm=0.8), best_val_acc=0.97200
    # batch_size = 32, epoch=100, lr=2e-2, momentum=0.8, best_val_acc=0.96700
    # batch_size = 16, epoch=100, lr=2e-2, momentum=0.8, best_val_acc=0.95900
    # batch_size = 32, epoch=100, lr=2e-2, momentum=0.6, best_val_acc=0.96950
    # batch_size = 16, epoch=100, lr=2e-2, momentum=0.6, best_val_acc=0.96700
    # batch_size = 32, epoch=100, lr=2e-2, momentum=0.4, best_val_acc=0.96700
    # batch_size = 16, epoch=100, lr=2e-2, momentum=0.4, best_val_acc=0.97050
    # batch_size = 32, epoch=100, lr=2e-2, momentum=0.2, best_val_acc=0.96600
    # batch_size = 16, epoch=100, lr=2e-2, momentum=0.2, best_val_acc=0.97250
    # batch_size = 32, epoch=100, lr=2e-2, momentum=0.0, best_val_acc=0.97050
    # batch_size = 16, epoch=100, lr=2e-2, momentum=0.0, best_val_acc=0.96550

    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.75, best_val_acc=0.97150
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.85, best_val_acc=0.97150
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.9, best_val_acc=0.97000
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.7, best_val_acc=0.96750
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.5, best_val_acc=0.96200
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.3, best_val_acc=0.96200

    # batch_size = 32, epoch=100, lr=2e-3, momentum=0.6, best_val_acc=0.94900
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.6, best_val_acc=0.96700
    # batch_size = 32, epoch=100, lr=2e-3, momentum=0.4, best_val_acc=0.95700
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.4, best_val_acc=0.96300
    # batch_size = 32, epoch=100, lr=2e-3, momentum=0.2, best_val_acc=0.87250
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.2, best_val_acc=0.94700
    # batch_size = 32, epoch=100, lr=2e-3, momentum=0.0, best_val_acc=0.93100
    # batch_size = 16, epoch=100, lr=2e-3, momentum=0.0, best_val_acc=0.94950
