#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 19-7-13 上午11:40
# @Author  : tangming
# @File    : tc_net_rnn_onernn_notime_pool5.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 19-7-4 下午9:13
# @Author  : tangming
# @File    : tc_net_rnn_onernn_notime_pool4.py
...
from keras.layers import Dense, LSTM, GRU, Dropout, Input, Conv2D, BatchNormalization, MaxPooling2D, Flatten, Reshape,SpatialDropout2D
...
def create_model():
    ...
    pool3 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), padding='same')(conv3)
    ...
    pool4 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), padding='same')(conv4)
    ...
    gru_input = Reshape((4, 320))(batch_normal4)
...
if __name__ == '__main__':
    ...
    # 模型训练,checkpoint
    filepath = "./realdata_model/cnn4yes_pool_single_gru1fc0shared-{epoch:02d}-{val_acc:.4f}.hdf5"
