...
def create_model():
    ...
    dropout1 = Dropout(0.5)(batch_normal_5)
    # output-layer
...
if __name__ == '__main__':
    ...
    # batch_size = 128, epoch=100, best_val_acc=0.89400
    # batch_size = 64, epoch=100, best_val_acc=0.95200
    # batch_size = 32, epoch=100, best_val_acc=0.96450
