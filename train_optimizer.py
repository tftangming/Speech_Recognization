...
if __name__ == '__main__':
    ...
    history.end_draw()
    # baseline: batch_size=16, dropout=0.3 , optimizer= SGD(2e-3),
    # <batch_size:16/32> dropout=0.3 <optimizer:SGD,RMSprop, Adagrad, Adadelta, Adam, Adamax, Nadam>
    # batch_size = 32, epoch=100, best_val_acc=0.96800; <= SGD
    # batch_size = 16, epoch=100, best_val_acc=0.97200
    # batch_size = 32, epoch=100, best_val_acc=0.96250; <= RMSprop
    # batch_size = 16, epoch=100, best_val_acc=0.96450
    # batch_size = 32, epoch=100, best_val_acc=0.96250; <= Adagrad
    # batch_size = 16, epoch=100, best_val_acc=0.96450;
    # batch_size = 32, epoch=100, best_val_acc=0.96750; <= Adadelta
    # batch_size = 16, epoch=100, best_val_acc=0.96650;
    # batch_size = 32, epoch=100, best_val_acc=0.97200; <= Adam
    # batch_size = 16, epoch=100, best_val_acc=0.95700;
