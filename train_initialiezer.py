...
def create_model():
    ...
    # CONV-RELU-POOL 1
    conv1 = Conv2D(16, (5, 5), activation="relu", kernel_initializer="he_normal", kernel_regularizer=regularizers.l2(0.01))(model_input)
    pool1 = MaxPooling2D(pool_size=(3, 3), strides=(1, 2), padding='same')(conv1)
    batch_normal1 = BatchNormalization(axis=-1)(pool1)
    # CONV-RELU-POOL 2
    conv2 = Conv2D(32, (3, 3), activation="relu", kernel_initializer="he_normal",  kernel_regularizer=regularizers.l2(0.01))(batch_normal1)
    pool2 = MaxPooling2D(pool_size=(3, 3), strides=(1, 2), padding='same')(conv2)
    batch_normal2 = BatchNormalization(axis=-1)(pool2)
    # CONV-RELU-POOL 3
    conv3 = Conv2D(32, (3, 3), activation="relu", kernel_initializer="he_normal",  kernel_regularizer=regularizers.l2(0.01))(batch_normal2)
    pool3 = MaxPooling2D(pool_size=(3, 3), strides=(1, 2), padding='same')(conv3)
    batch_normal3 = BatchNormalization(axis=-1)(pool3)
    # CONV-RELU-POOL 3
    conv4 = Conv2D(32, (3, 3), activation="relu", kernel_initializer="he_normal", kernel_regularizer=regularizers.l2(0.01))(batch_normal3)
    ...
    # output-layer
    model_output = Dense(10, activation="softmax", kernel_initializer='he_normal',
...
if __name__ == '__main__':
    ...
    # 默认的初始化: best_val_acc: 0.97000
    # glorot_normal: 0.96250
    #
